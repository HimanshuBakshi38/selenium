...
public class SendEmailReportSeleniumCases {
	...
	public static void f() {
		try {
			...
			recipients[0] = "testingallprojects@gmail.com"; 
			//recipients[0] = "sid.nannuri@gmail.com"; 
			recipients[1] = "himanshuqa0509@gmail.com";
			...
			String path = "C:\\Users\\HP pc 2\\eclipse-workspace\\AnythonQA\\test-output\\emailable-report.html";
			...
			msg.setSubject("Automation Test Status");
			BodyPart msgBody = new MimeBodyPart();
			// Setting email's message body
			msgBody.setText("Automation Testing Report of Fabulate Tests");
			...
			transport.connect("smtp.gmail.com", 465, "himanshuqa0509@gmail.com", "Himanshu12!@");
